...
BASE_EMAIL_BODY = (
    ...
    '4. whether you have familiarized yourself with the Information Security Policy of RT MIS LLC.\n\n'
    ...
    'Consequences of non-compliance with these requirements will be considered by the management of RT MIS LLC and may lead to disciplinary sanctions up to termination of employment contract.\n\n'
