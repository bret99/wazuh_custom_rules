...
def fetch_user_info(client):
    ...
    for hit in resp.get('hits', {}).get('hits', []):
        try:
            ...
            confluence_creator = source.get("confluence_creator")
...
def main():
    ...
    for username, info in sorted(user_info.items()):
        ...
        try:
            ...
            success_msg = f"Successfully sent: {email} (Confluence page: {info['confluence_task']}, Secret: {info['confluence_secret']})"
            print(success_msg)
