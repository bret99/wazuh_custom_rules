...
BASE_EMAIL_BODY = (
    ...
    '1. **Prohibition of remote work outside the Russian Federation**: Use of systems is possible only from the territory of the Russian Federation, which is due to currency control requirements and personal data protection.\n'
    '2. **Employment contract**: Your employment contract implies that your workplace must be located on the territory of the Russian Federation.\n'
    ...
    '4. **Legislation**: Cross-border transfer of personal data and commercial secrets may entail legal liability in accordance with Federal Laws No. 152-FZ and No. 98-FZ.\n\n'
